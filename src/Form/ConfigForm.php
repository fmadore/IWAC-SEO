...
/**
 * Module configuration form (Modules → IWAC SEO → Configure).
 *
...
class ConfigForm extends Form
{
    public function init(): void
    {
        ...
        $this->add([
            'name'    => 'iwac_seo_gsc_verification',
            ...
            'attributes' => [
                'id'          => 'iwac_seo_gsc_verification',
                'placeholder' => '<meta name="google-site-verification" content="…" />',
            ],
        ]);

        $this->add([
            'name'    => 'iwac_seo_bing_verification',
            'type'    => Element\Text::class,
            'options' => [
            ...
            'attributes' => ['id' => 'iwac_seo_bing_verification'],
        ]);

        // ── Defaults applied when a page has nothing more specific ──────────
        $this->add([
            'name'    => 'iwac_seo_default_description',
            ...
            'attributes' => ['id' => 'iwac_seo_default_description', 'rows' => 3],
        ]);

        $this->add([
            'name'    => 'iwac_seo_default_share_image',
            'type'    => Asset::class,
            'options' => [
            ...
            'attributes' => ['id' => 'iwac_seo_default_share_image'],
        ]);

        $this->add([
            'name'    => 'iwac_seo_twitter_site',
            'type'    => Element\Text::class,
            'options' => [
                'label' => 'Twitter / X @handle', // @translate
                'info'  => 'Optional. The site account, e.g. @ZMO_Berlin — emitted as twitter:site.', // @translate
            ],
            'attributes' => ['id' => 'iwac_seo_twitter_site', 'placeholder' => '@handle'],
        ]);

        // ── Indexing policy ─────────────────────────────────────────────────
        $this->add([
            'name'    => 'iwac_seo_noindex_site',
        ...
        $this->add([
            ...
            'attributes' => ['id' => 'iwac_seo_sitemap_enabled'],
        ]);

        $this->add([
            'name'    => 'iwac_seo_sitemap_ttl',
            ...
            'attributes' => ['id' => 'iwac_seo_sitemap_ttl', 'min' => 0, 'step' => 1, 'placeholder' => '86400'],
        ]);

        // ── IndexNow auto-ping ──────────────────────────────────────────────
        $this->add([
            'name'    => 'iwac_seo_ping_enabled',
            'type'    => Element\Checkbox::class,
            'options' => [
        ...
        $this->add([
            ...
            'attributes' => ['id' => 'iwac_seo_indexnow_key'],
        ]);
